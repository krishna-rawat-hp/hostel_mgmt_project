...
<body style="overflow-x: hidden;">
	...
	<img src="../images/img.jpg" width="100%" height="750vh">
	<div id="login">
			...
			<div id="login-column" class="col-md-6">
				...
				<div id="login-box" class="col-md-12">
					...
					<form id="login-form" class="form" action="user_home.php" method="GET">
						...
						<div id="register-link" class="text-right">
							<a href="#" class="text-info" style="font-size: 18px;">Register Here</a>
						</div>
					</form>
